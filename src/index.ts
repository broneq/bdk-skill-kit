// The public surface of bdk-skill-kit: what a config file and a rule plugin
// import. It imports nothing relative, so `pnpm build` emits its declarations
// as one self-contained dist/index.d.ts.
...
export function defineRule<O extends object = Record<string, unknown>>(rule: Rule<O>): Rule<O> {
  return rule;
}
